...
TMW.TwitterPoll = {
    ...
    EventListeners: {
        ...
        onPageStart: function() {
            ...
            var a = (TMW.TwitterPoll.createEl("button", "LOAD MORE", "section--tweets", "btn btn--more"), 
            TMW.TwitterPoll.createEl("button", "SMASH!", "section--power", "btn btn--smash"));
            TMW.TwitterPoll.updatePower(), TMW.TwitterPoll.btnConfirm.addEventListener("click", function() {
                "send" === TMW.TwitterPoll.ACTIONTYPE ? TMW.TwitterPoll.sendTweet(TMW.TwitterPoll.TWEET) : TMW.TwitterPoll.destroyTweet(TMW.TwitterPoll.TWEET), 
    ...
    tweetRecieved: function(a) {
        ...
        c.className = "g-col g-span8", d.className = "g-col g-span4", b = document.createElement("li"), 
        b.className = "tweet tweet-" + a.id;
        ...
        e.addEventListener("click", function() {
            TMW.TwitterPoll.ACTIONTYPE = "send", TMW.TwitterPoll.TWEET = a, TMW.TwitterPoll.checkAction("send", a);
        }), f.addEventListener("click", function() {
            TMW.TwitterPoll.ACTIONTYPE = "delete", TMW.TwitterPoll.TWEET = a, TMW.TwitterPoll.checkAction("delete", a);
        }), d.appendChild(e), d.appendChild(f);
        var g = document.createElement("a");
        g.setAttribute("href", "http://www.twitter.com/" + a.screenName), g.setAttribute("target", "_new"), 
        g.className = "title title-tweet", g.innerHTML = "@" + a.screenName;
        var h = document.createElement("p");
        h.className = "content content-tweet", h.innerHTML = a.text, c.appendChild(g), c.appendChild(h), 
    ...
    checkAction: function(a, b) {
        ...
        removeClass(TMW.TwitterPoll.MODALWINDOW, "modal--delete")) : (TMW.TwitterPoll.MODALTITLE.innerHTML = "REMOVE TWEET?", 
        TMW.TwitterPoll.MODALCONTENT.innerHTML = "Delete Lorem Ipsum is simply dummy text of the printing and typesetting industry", 
        addClass(TMW.TwitterPoll.MODALWINDOW, "modal--delete")), removeClass(TMW.TwitterPoll.MODALWINDOW, "is-hidden"), 
        TMW.TwitterPoll.MODALSUBTITLE.innerHTML = "@" + c;
    },
