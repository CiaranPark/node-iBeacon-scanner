...
TMW.TwitterPoll = {
    ...
    tweetRecieved: function(a) {
        ...
        var e = TMW.TwitterPoll.createEl("button", "Send", null, "btn btn--send"), f = TMW.TwitterPoll.createEl("button", "Delete", null, "btn btn--delete"), g = "@" + a.name + ": " + a.text;
        ...
        h.className = "tweet-title", h.innerHTML = "@" + a.name;
