...
TMW.TwitterPoll = {
    ...
    init: function() {
        ...
        this.EventListeners.onPageStart(), this.EventListeners.onPowerChange(), this.EventListeners.onApproveTweet();
    },
    ...
    EventListeners: {
        ...
        onTweet: function() {
            log("script.js :: setup event listener :: onTweet"), TMW.TwitterPoll.socket.on("tweet", TMW.TwitterPoll.tweetRecieved);
        },
        onPowerChange: function() {
            log("power change listening"), this.POWER_LEVEL.addEventListener("change", TMW.TwitterPoll.updatePower, !1);
        },
        onApproveTweet: function() {}
    },
    ...
    tweetRecieved: function(a) {
        log("tweet added");
        var b, c = a.text + "<button class='btn--tweet' value='Send to Bat'>Send to Bat</button>";
        b = document.createElement("li"), b.innerHTML = c, TMW.TwitterPoll.wallContent.prependChild(b), 
        b.addEventListener("click", function() {
            log("added to list"), TMW.TwitterPoll.destroyTweet(this.parentNode);
        }), document.querySelector("#last-update").innerHTML = new Date().toTimeString();
    },
    updatePower: function() {
        var a = document.querySelector(".current-Power");
        a.innerHTML = document.querySelector(".power").value;
    },
