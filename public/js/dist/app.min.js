...
TMW.TwitterPoll = {
    ...
    EventListeners: {
        ...
        onPageStart: function() {
            ...
            TMW.TwitterPoll.setMeter(), TMW.TwitterPoll.updatePower(), TMW.TwitterPoll.btnConfirm.addEventListener("click", function() {
                ...
                "U+0020" == a.keyIdentifier && (TMW.TwitterPoll.socket.emit("tweet-sent", "6"), 
                a.preventDefault());
            });
        },
        onTweet: function() {
        ...
        onReset: function(a) {
            "ACW" === a ? TMW.TwitterPoll.socket.emit("tweet-sent", "7") : "CW" === a && TMW.TwitterPoll.socket.emit("tweet-sent", "8");
        },
        ...
        onDeleteTweet: function(a, b) {
            TMW.TwitterPoll.ACTIONTYPE = "delete", TMW.TwitterPoll.TWEET = b, TMW.TwitterPoll.destroyTweet(TMW.TwitterPoll.TWEET);
        }
    },
    ...
    setMeter: function() {
        ...
        var e = TMW.TwitterPoll.createEl("button", "SMASH!", "section--power", "btn btn--smash"), f = TMW.TwitterPoll.createEl("button", "RESET ACW", "section--power", "btn btn--reset"), g = TMW.TwitterPoll.createEl("button", "RESET CW", "section--power", "btn btn--reset");
        e.addEventListener("click", TMW.TwitterPoll.EventListeners.onSmash), f.addEventListener("click", function() {
    ...
    tweetRecieved: function(a) {
        ...
        var e = TMW.TwitterPoll.createEl("button", "Send", null, "btn btn--send"), f = TMW.TwitterPoll.createEl("button", "Delete", null, "btn btn--delete"), g = "@" + a.screenName + ": " + a.text;
        e.setAttribute("data-clipboard-text", g);
        new ZeroClipboard(e);
        ...
        h.setAttribute("href", "http://www.twitter.com/" + a.name), h.setAttribute("target", "_new"), 
        h.className = "tweet-title", h.innerHTML = "@" + a.screenName;
        var i = document.createElement("p");
        i.className = "content tweet-text", i.innerHTML = a.text, c.appendChild(h), c.appendChild(i), 
    ...
    saveToClipboard: function(a, b) {
        log(b);
        var c = b.name + b.text, d = a.clipboardData;
        d.setData("text/plain", c);
    },
    ...
    sendTweet: function(a) {
        TMW.TwitterPoll.CURRENTLEVEL = document.querySelector(".slider").value;
        var b = document.querySelector(".tweet-" + a.id);
        addClass(b, "sent"), TMW.TwitterPoll.socket.emit("tweet-sent", TMW.TwitterPoll.CURRENTLEVEL);
    }
