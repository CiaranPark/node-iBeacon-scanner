...
TMW.TwitterPoll = {
    ...
    EventListeners: {
        ...
        onPageStart: function() {
            ...
            new ZeroClipboard(TMW.TwitterPoll.btnConfirm);
    ...
    setMeter: function() {
        ...
        var e = TMW.TwitterPoll.createEl("button", "SMASH!", "section--power", "btn btn--smash"), f = TMW.TwitterPoll.createEl("button", "RESET", "section--power", "btn btn--reset");
        e.addEventListener("click", TMW.TwitterPoll.EventListeners.onSmash), f.addEventListener("click", TMW.TwitterPoll.EventListeners.onReset);
    },
    ...
    tweetRecieved: function(a) {
        ...
        g.setAttribute("href", "http://www.twitter.com/" + a.name), g.setAttribute("target", "_new"), 
        g.className = "tweet-title", g.innerHTML = "@" + a.name;
    ...
    checkAction: function(a, b) {
        var c = b.name;
        if ("send" === TMW.TwitterPoll.ACTIONTYPE) {
            TMW.TwitterPoll.MODALTITLE.innerHTML = "SEND TO BAT?", TMW.TwitterPoll.MODALCONTENT.innerHTML = b.text, 
            removeClass(TMW.TwitterPoll.MODALWINDOW, "modal--delete");
            var d = TMW.TwitterPoll.MODALWINDOW.querySelector(".btn--true"), e = "@" + b.name + ": " + b.text;
            d.setAttribute("data-clipboard-text", e);
        } else TMW.TwitterPoll.MODALTITLE.innerHTML = "REMOVE TWEET?", TMW.TwitterPoll.MODALCONTENT.innerHTML = b.text, 
